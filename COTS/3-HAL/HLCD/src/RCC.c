...
MRCC_enuErrorStatus_t MRCC_enuGetSystemClock(volatile uint64_t* Addr_uint64Clock){
...
MRCC_enuErrorStatus_t MRCC_enuEnableClock(MRCC_enuClockCfg_t Copy_enuClockCfg ){
    ...
    switch (Copy_enuClockCfg)
    {
        ...
        case MRCC_enu_PLL:
            ...
            break;
        default:
            Ret_enuErrorStatus = MRCC_enu_INVALID_CLOCK_CONFIGRATION;
            break;
    }
    if(Local_uint32ClockStatus == 0)
        Ret_enuErrorStatus = MRCC_enu_CLOCK_NOT_READY;
